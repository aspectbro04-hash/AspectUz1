...
export class GameManager {
  ...
  createRoom(hostName: string, socketId: string, sessionId: string): string {
  ...
  joinRoom(roomId: string, playerName: string, socketId: string, sessionId: string): GameState | null {
  ...
  private checkVotes(roomId: string) {
     // Check if everyone voted? Or just wait for timer.
  }
